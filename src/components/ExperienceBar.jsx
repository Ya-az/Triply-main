...
function ExperienceBar() {
  ...
  return (
    <div className="fixed top-0 inset-x-0 z-[100] bg-gradient-to-r from-triply via-triply-teal to-triply-mint dark:from-triply-dark dark:via-triply-teal dark:to-triply-mint text-white dark:text-dark-text-primary py-2 px-4 shadow-lg animate-slideDown">
      <div className="mx-auto max-w-6xl flex items-center justify-between gap-2 sm:gap-4">
        <div className="flex items-center gap-3 sm:gap-6 text-xs sm:text-sm font-medium flex-1 overflow-x-auto">
        ...
        <button
          ...
          className="flex-shrink-0 p-1 rounded-lg hover:bg-white/10 dark:hover:bg-dark-surface/30 transition-colors"
          aria-label="إغلاق"
        >
