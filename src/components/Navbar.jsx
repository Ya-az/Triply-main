    ...
    <header className="fixed inset-x-0 top-0 has-experience-bar:top-10 z-50 border-b border-white/20 dark:border-dark-border/40 bg-white/75 dark:bg-dark-surface/90 backdrop-blur-xl transition-all duration-300">
      <nav className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 py-4">
        <HashLink
          ...
          className="flex items-center gap-3 text-triply-dark dark:text-dark-text-primary"
        >
          <img
            src={logo}
            alt="Triply logo"
        ...
        <div className="hidden items-center gap-3 lg:flex">
          ...
          {username ? (
            <>
              <span className="rounded-full bg-triply-mint/20 dark:bg-dark-elevated px-4 py-2 text-sm font-medium text-triply-dark dark:text-dark-text-primary">
                مرحباً، {username}
              </span>
      ...
      >
        <nav className="flex flex-col gap-2 px-6 py-4">
          ...
          <div className="mt-3 flex flex-col gap-2">
            {username ? (
              <>
                <div className="rounded-xl bg-triply-mint/20 dark:bg-dark-elevated px-4 py-3 text-center text-sm font-medium text-triply-dark dark:text-dark-text-primary">
                  مرحباً، {username}
                </div>
                <GlassButton
                  variant="outline"
