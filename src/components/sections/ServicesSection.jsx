...
function ServicesSection() {
  return (
    <section id="services" className="section-padding relative">
      <div className="absolute inset-x-0 top-0 -z-10 h-64 bg-triply-mint/20 dark:bg-triply-teal/10 blur-3xl" aria-hidden="true" />
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-6 text-right">
        <div className="space-y-4">
          ...
          <h2 className="font-display text-3xl text-triply-dark dark:text-dark-text-primary md:text-4xl">كل تفاصيل الرحلة في مكان واحد</h2>
